...
class SpecificDaysSchedulerScreen extends ConsumerStatefulWidget {
  const SpecificDaysSchedulerScreen({this.initialMedicationId, super.key});

  final int? initialMedicationId;

  @override
  ConsumerState<SpecificDaysSchedulerScreen> createState() =>
      _SpecificDaysSchedulerScreenState();
}

class _SpecificDaysSchedulerScreenState
    extends ConsumerState<SpecificDaysSchedulerScreen> {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: serene.spacing.lg),
                      Wrap(
                        spacing: serene.spacing.sm,
                        runSpacing: serene.spacing.sm,
                        children: [
                          _dayChip(1, l10n.dayMon),
                          _dayChip(2, l10n.dayTue),
                          _dayChip(3, l10n.dayWed),
                          _dayChip(4, l10n.dayThu),
                          _dayChip(5, l10n.dayFri),
                          _dayChip(6, l10n.daySat),
                          _dayChip(7, l10n.daySun),
                        ],
                      ),
                      SizedBox(height: serene.spacing.xl),
                      Row(
  ...
  void _addTime() {
    setState(() => _times.add(const TimeOfDay(hour: 21, minute: 0)));
  }
  ...
  Future<void> _save() async {
    final l10n = AppLocalizations.of(context);
    if (_medicationId == null || _selectedDays.isEmpty) {
    ...
    await persistNewSchedule(
      ref: ref,
      context: context,
      schedule: Schedule.specificDays(
        id: 0,
...
class _MedicationReadOnlyChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.medication, size: 18, color: theme.colorScheme.primary),
